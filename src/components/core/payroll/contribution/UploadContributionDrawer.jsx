...
import UploadContributionForm from "./UploadContributionForm";
...
const UploadContributionDrawer = ({
  isOpen,
  handleCloseDrawer,
  defaultValues,
}) => {
...
UploadContributionDrawer.propTypes = {
  isOpen: PropTypes.bool,
  handleCloseDrawer: PropTypes.func,
  defaultValues: PropTypes.object,
};

export default UploadContributionDrawer;
