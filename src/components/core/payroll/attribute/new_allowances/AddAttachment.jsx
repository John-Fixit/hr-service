...
const AddAttachment = ({
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      setValue("group_excel", uploadedAttachmentIDs[0]);
    ...
    <>
      <div className="">
        <form onSubmit={onSubmit}>
          ...
          <div className="w-full px-7 bg-gray-100 rounded-xl p-6">
            <div
              className={`border-2 border-dashed border-gray-300 rounded-xl p-4 min-h-[15rem]`}
            >
              <div>
                <div className="flex flex-col justify-center items-center">
                  ...
                  <p className="text-gray-500">Excel File (.xlsx)</p>
                </div>
              </div>
            </div>
          </div>
