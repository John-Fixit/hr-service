...
import StaffBenefit from "./form/StaffBenefit";
import SuspensionAttachment from "../suspension/add_suspension_forms/SuspensionAttachment";
import SuspensionNote from "../suspension/add_suspension_forms/SuspenstionNote";
import StaffForm from "./form/StaffForm";
import BankDetails from "./form/BankDetails";

const ActiveStaffDrawer = ({ setIsOpen, isOpen }) => {
          ...
          <div className="bg-[#f5f7fa] min-h-screen px-5 py-5">
            ...
            <div className="grid grid-cols-1 h-ful md:grid-cols-4 gap-x-7 gap-y-5">
              <div className="my- w-full p-5 overflow-y-auto col-span-3 shadow-xl bg-white rounded-[0.25rem] mb-[1rem] form_drawer_body_container order-2 md:order-1 ">
                ...
                {tabs[selectedTab]?.title.toLowerCase() == "bank details" && (
                  <BankDetails
                    // control={control}
                    // setValue={setValue}
                    // getValues={getValues}
...
ActiveStaffDrawer.propType = {
  setIsOpen: propTypes.func.isRequired,
  isOpen: propTypes.bool.isRequired,
};

export default ActiveStaffDrawer;
