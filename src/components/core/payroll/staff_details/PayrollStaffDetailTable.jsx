...
const tableHead = [
  ...
  { name: "TITLE", column_name: "TITLE" },
  { name: "ADDRESS 1", column_name: "ADDRESS_1" },
  { name: "GENDER", column_name: "GENDER" },
  { name: "DOB", column_name: "DATE_OF_BIRTH" },
  { name: "MARITAL STATUS", column_name: "MARITAL_STATUS" },
  { name: "STATE", column_name: "STATE" },
  { name: "LGA", column_name: "LGA" },
  { name: "DATE EMPLOYED", column_name: "DATE_EMPLOYED" },
  { name: "DIVISION NAME", column_name: "DIVISION_NAME" },
  { name: "GRADE", column_name: "GRADE" },
  { name: "BANK", column_name: "BANK" },
  { name: "ACCOUNT NUMBER", column_name: "ACCOUNT_NUMBER" },
  { name: "RANK NAME", column_name: "RANK" },
  { name: "NHF NUMBER", column_name: "NHF_NO" },
  { name: "PFA CODE", column_name: "PFA_CODE" },
  { name: "PFA ACCOUNT NUMBER", column_name: "PFA_ACCOUNT_NUMBER" },
  { name: "TIN NUMBER", column_name: "TIN_NUMBER" },
  { name: "ACTION", column_name: "ACTION" },
];

const PayrollStaffDetailTable = ({ tableData, isLoading }) => {
...
export default PayrollStaffDetailTable;
