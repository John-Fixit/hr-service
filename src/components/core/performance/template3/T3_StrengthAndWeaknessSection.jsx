...
const T3_StrengthAndWeaknessSection = ({
  ...
  //   const updatedAssessment = {...strenghtWeekness};
  //   updatedAssessment[index] = value;
  //   setStrenghtWeekness(updatedAssessment);
  //   setValue("strenghtAndWeekness", updatedAssessment, { shouldValidate: true });
  // };
...
T3_StrengthAndWeaknessSection.propTypes = {
...
export default T3_StrengthAndWeaknessSection