...
const T2_EmployeePotentialSection = ({
  appraisee,
  register,
  setValue,
  watch,
        ...
        <CardBody className="px-6 w-full rid md:rid-cols2 gap-3">
          {(isApprovalPage || !appraisee) && (
            <>
              <div className="col-span-7">
                <div className="mt-6 mb-3 ">
                  ...
                  // })}
                  onChange={(e) => setValue("overall_evaluation", e.target.value)}
                ...
                <div className="rid rid-cols-8 gap-4">
                  <div className="col-span-3">
                    <p className="text-zinc-500">
                      Assesssor&apos;s comment on the above should include
            ...
            placeholder="Comment here...."
                    ...
                    status={formState.errors?.rating_comment === ""?  "error": ""}
                    onChange={(e)=>setValue("rating_comment", e.target.value)}
                    />
              ...
              <div className="col-span-8 mt-3">
                <div className="rid rid-cols-8 gap-4">
                  ...
                  status={formState.errors?.promotability ? "error" : ""}
            placeholder="Comment here...."
            onChange={(e)=>setValue("promotability", e.target.value)}
            value={watch('promotability')}
              ...
              <div className="col-span-8 mt-3">
                <div className="rid rid-cols-8 gap-4">
                  ...
                  status={formState.errors?.reporting_officer_comment ? "error" : ""}
                  onChange={(e)=>setValue("reporting_officer_comment", e.target.value, {
                    shouldValidate: true,  
                  })}
              ...
              <div className="col-span-8 mt-3">
                <div className="rid rid-cols-8 gap-4">
                  ...
                  <div className="col-span-5">
                  <Input.TextArea
                   disabled={isApprovalPage && current_level !== "counter officer" }
            placeholder="Comment here...."
            status={
            ...
            onChange={(e)=>setValue("countersigning_comment", e.target.value)}
...
export default T2_EmployeePotentialSection;
