...
export default function AddNoteRejection({handleConfirm, handleCancel, loading}) {
  ...
  return (
    <>
      <div  >
        ...
        <h2 className="mb-5 text-[1rem] my-auto font-[600] font-helvetica text-[#444e4e] capitalize">Confirm Rejection</h2>
          ...
          <div className="_compose_submit flex gap-6 mt-3">
            ...
            <Button
              ...
              radius="sm"
              disabled={loading}
              className="px-3 font-helvetica bg-red-500 disabled:cursor-not-allowed disabled:bg-gray-300 flex items-center gap2-2"
