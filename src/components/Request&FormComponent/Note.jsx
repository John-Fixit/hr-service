...
const Note = ({ setInformation, goToNextTab, setValue,isLoading, handleSubmit }) => {
//   const [notes, setNotes] = useState([])
  ...
  return {...information, notes:e.target.value}
  })
  }
  }
    ...
    <div className='p-8 bg-white shadow rounded'>
      ...
      <div>
        <div>
          ...
          <button
            type="button"
            className={`header_btnStyle bg-[#00bcc2] rounded text-white font-semibold py-[8px] leading-[19.5px mx-2 my-1 text-[0.7125rem] md:my-0 px-[25px] uppercase active:bg-btnColor/50 font-helvetica tracking-[1px]`}
