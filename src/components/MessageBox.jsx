...
import ConfirmDeleteModal from "./core/shared/ConfirmDelete";
...
const MessageBox = ({ data, isLarge, otherUser }) => {
  ...
  const {deleteAChat} = useContext(SocketContext);
    ...
    <div className="flex flex-col ">
      <div className={container}>
        <div className={avatar}>
          ...
          {otherUser?.LAST_NAME === "Support Team" ? (
            <Avatar
              //  size="sm"
              className="bg-supportIconBg  text-white w-5 h-5 "
          ...
          otherUser?.FILE_NAME ? (
            <Avatar
              ...
              src={filePrefix + otherUser?.FILE_NAME}
            />
          ) : (
            <Avatar
              size="sm"
