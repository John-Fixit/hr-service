...
export const APINEW = axios.create({
  baseURL: `https://hrnew.creditclan.com/index.php/`,
}); //https://hrnew.creditclan.com/api/index.php/
...
export const APIAPPROVAL = axios.create({
  baseURL: `https://hrnew.creditclan.com/index.php/`,
}); //https://hrnew.creditclan.com/api/index.php/
...
export const LMS_API = axios.create({
  //api for LMS testing
  baseURL: `https://lms-community.onrender.com/api/`,
});
LMS_API.interceptors.request.use((req) => {
  // Get the token dynamically on each request
  const token = JSON.parse(localStorage.getItem("communeety-auth-session"))
    ?.state?.userData?.token;
...
export const APIAttendance = axios.create({
  baseURL: `https://blockchain.creditclan.com/api/`,
}); //https://blockchain.creditclan.com/hr/api/
