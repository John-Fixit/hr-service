    ...
    <div className="relative ">
      ...
      >
        ...
        >
          ...
          <button
            className="flex items-center gap-3.5 py-4 px-6 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base group bg-red-50/30"
            onClick={logout}
          >
            <svg
              className="fill-current group-hover:rotate-45 duration-75 ease-in-out"
      ...
      <ExpandedDrawerWithButton
        ...
        maxWidth={450}
      >
        <StaffResetPassword closeDrawer={handleClosePasswordDrawer} />
      </ExpandedDrawerWithButton>
    </div>
  );
};
